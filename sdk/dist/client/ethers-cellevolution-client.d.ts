...
import { CellHistory, CellEvolution as _CellEvolution } from '../model/chain';
import { CellEvolutionNewWorld as CellEvolution } from '../typechain';
export declare class EtherCellEvolutionClient implements CellEvolutionClient {
    private cellEvolution;
    private provider;
    private signer;
    private _waitConfirmations;
    ...
    contract(): Promise<CellEvolution>;
    inheritance(config?: PayableOverrides): Promise<Array<BigNumber>>;
    getCellHistory(cellHistoryId: BigNumber, config?: PayableOverrides): Promise<CellHistory>;
    ...
    setHomeworld(worldId: BigNumber, newtitle: string, config?: PayableOverrides): Promise<any>;
    writeworld(cellHistory: CellHistory, config?: PayableOverrides): Promise<any>;
    writecell(cellEvolution: _CellEvolution, config?: PayableOverrides): Promise<any>;
    dnamerge(id: BigNumber, cellno: BigNumber, adaption: BigNumber, surviveability: BigNumber, division: BigNumber, environment: BigNumber, day: BigNumber, totoalscore: BigNumber, finaltitle: string, config?: PayableOverrides): Promise<any>;
    newinheritance(config?: PayableOverrides): Promise<any>;
    worldtitlecheck(config?: PayableOverrides): Promise<any>;
    checkdeath(cellno: BigNumber, adaption: BigNumber, surviveability: BigNumber, division: BigNumber, config?: PayableOverrides): Promise<any>;
}
