...
export interface CellEvolutionClient {
    ...
    dnamerge(id: BigNumber, cellno: BigNumber, adaption: BigNumber, surviveability: BigNumber, division: BigNumber, environment: BigNumber, day: BigNumber, totalscore: BigNumber, finaltitle: string, config: PayableOverrides): Promise<any>;
